...
class AnnualReportController extends Controller
{
    ...
    private const DIR = 'annual-reports';

    public function index()
    {
        $reports = AnnualReport::orderBy('priority')->orderBy('id')->get();

        return view('backend.investors.annual_report.index', compact('reports'));
    }

    public function create()
    {
        $isFirst = AnnualReport::count() === 0;

        return view('backend.investors.annual_report.create', compact('isFirst'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manage-annual-report.index')->with('message', 'Annual report added successfully.');
    }

    public function edit($id)
    {
        $report  = AnnualReport::findOrFail($id);
        $isFirst = $report->id === AnnualReport::orderBy('id')->value('id');

        return view('backend.investors.annual_report.edit', compact('report', 'isFirst'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('manage-annual-report.index')->with('message', 'Annual report updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('manage-annual-report.index')->with('message', 'Annual report deleted successfully.');
    }
    ...
    private function rules(bool $isFirst, ?int $ignoreId = null): array
    {
        ...
        $rules = [
            ...
            'pdf'       => "{$req}|file|mimes:pdf|max:10240",
