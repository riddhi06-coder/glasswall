      ...
      <div class="row m-0">
        <div class="col-12 p-0">    
          <div class="login-card login-dark">
            <div>
              <div><a class="logo" href="{{ route('admin.login') }}"> <img class="img-fluid for-dark" src="{{ asset('admin/assets/images/logo/gws.webp') }}" alt="" style="max-width: 17% !important; background-color:#6c757d;"><img class="img-fluid for-light" src="{{ asset('admin/assets/images/logo/gws.webp') }}" alt="looginpage" style="max-width: 25% !important; background-color:#6c757d;"></a></div>
