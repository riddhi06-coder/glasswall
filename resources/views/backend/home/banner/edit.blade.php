          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <p class="f-m-light mt-1">Update the banner details and submit the form.</p>
              </div>
              <div class="card-body">
                    ...
                    <div class="col-12">
                      <div class="tab-content" id="wizard-tabContent">
                        <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel">
                          <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('banner-details.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-12">
                              ...
                              <textarea class="form-control editor @error('banner_heading') is-invalid @enderror" id="banner_heading" name="banner_heading" rows="4" placeholder="Enter Banner Heading">{{ old('banner_heading', $banner->banner_heading) }}</textarea>
                            ...
                            <div class="col-md-12">
                              ...
                              <input class="form-control @error('banner_title') is-invalid @enderror" id="banner_title" type="text" name="banner_title" placeholder="Enter Banner Title" value="{{ old('banner_title', $banner->banner_title) }}" required>
                              @error('banner_title')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                              @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                              ...
                              @if($banner->media_type === 'image')
                                <img src="{{ asset('home/bannerimagevideo/'.$banner->banner_media) }}" style="max-height:160px; border:1px solid #ddd; padding:5px;" class="img-fluid rounded" alt="current banner">
                              @else
                                <video controls style="max-height:160px; border:1px solid #ddd; padding:5px;">
                            ...
                            <!-- Banner Media -->
                            <div class="col-md-6">
                              <label class="form-label" for="banner_media">Replace Banner Image / Video</label>
                              <input
                              ...
                              <small class="text-secondary d-block mt-1">
                                ...
                                <b>Max size:</b> Image 2 MB, Video 5 MB. Leave blank to keep the current banner.
                              </small>

                              <!-- Preview BELOW input -->
                              <div id="bannerPreviewContainer" class="mt-3" style="display:none;">
                                <img id="banner_image_preview" class="img-fluid" style="max-height:200px; display:none; border:1px solid #ddd; padding:5px;">
                                <video id="banner_video_preview" controls style="max-height:200px; display:none; border:1px solid #ddd; padding:5px;"></video>
                              </div>
                            </div>
