    ...
    @include('components.backend.head')
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add About Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('home-about-details.index') }}">Home</a>
                    </li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('home-about-details.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
       ...
       @include('components.backend.main-js')
        ...
        <script>
            ...
            // Dynamic milestone rows (Icon / Count / Milestone) with add + remove.
            (function () {
                ...
                document.getElementById('addMilestoneRow').addEventListener('click', addRow);
                ...
                // Icon preview + size check (max 2 MB) per row.
