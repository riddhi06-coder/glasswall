    ...
    <div class="page-body">
      <div class="container-fluid">
        <div class="page-title">
          <div class="row">
            <div class="col-6"><h4>Edit Blog Section Form</h4></div>
            <div class="col-6">
              <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                      <div class="tab-content" id="wizard-tabContent">
                        <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel">
                          <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('home-blog-details.update', $blog->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-12">
                              ...
                              <input class="form-control @error('section_heading') is-invalid @enderror" id="section_heading" type="text" name="section_heading" value="{{ old('section_heading', $blog->section_heading) }}" placeholder="Enter Section Heading" required>
                            ...
                            <div class="col-md-12">
                              ...
                              <input class="form-control @error('api_link') is-invalid @enderror" id="api_link" type="url" name="api_link" value="{{ old('api_link', $blog->api_link) }}" placeholder="https://example.com/api/blogs" required>
