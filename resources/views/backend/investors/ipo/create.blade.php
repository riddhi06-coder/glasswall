              ...
              <div class="card-body">
                <form class="row g-4 needs-validation custom-input" novalidate action="{{ route('manage-ipo.store') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control @error('pdf') is-invalid @enderror" id="pdf" type="file" name="pdf" accept=".pdf,.mp4,.webm" required>
                    @error('pdf')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                    <small class="text-secondary d-block mt-1"><b>Allowed:</b> pdf, mp4 &nbsp;|&nbsp; <b>Max:</b> 20 MB</small>
                  </div>
