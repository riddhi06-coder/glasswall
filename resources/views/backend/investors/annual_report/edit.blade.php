    ...
    <div class="page-body">
      <div class="container-fluid">
        <div class="page-title">
          <div class="row">
            <div class="col-6"><h4>Edit Annual Report</h4></div>
            <div class="col-6">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('manage-annual-report.index') }}">Home</a></li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="row g-4 needs-validation custom-input" novalidate action="{{ route('manage-annual-report.update', $report->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  @if($isFirst)
                    <div class="col-md-6">
                      ...
                      <input class="form-control @error('banner_heading') is-invalid @enderror" id="banner_heading" type="text" name="banner_heading" value="{{ old('banner_heading', $report->banner_heading) }}" placeholder="e.g. Annual Reports" required>
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control @error('title') is-invalid @enderror" id="title" type="text" name="title" value="{{ old('title', $report->title) }}" placeholder="e.g. Annual Report 2025" required>
                  ...
                  <div class="col-md-6">
                    ...
                    <small class="text-secondary d-block mt-1"><b>Allowed:</b> pdf &nbsp;|&nbsp; <b>Max:</b> 10 MB &nbsp;|&nbsp;
                  ...
                  <div class="col-12 text-end mt-3">
                    <a href="{{ route('manage-annual-report.index') }}" class="btn btn-danger px-4">Cancel</a>
