    ...
    <div class="page-body">
      <div class="container-fluid">
        <div class="page-title">
          <div class="row">
            <div class="col-6"><h4>Add Annual Report</h4></div>
            <div class="col-6">
              <ol class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="row g-4 needs-validation custom-input" novalidate action="{{ route('manage-annual-report.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  @if($isFirst)
                    <div class="col-md-6">
                      ...
                      <input class="form-control @error('banner_heading') is-invalid @enderror" id="banner_heading" type="text" name="banner_heading" value="{{ old('banner_heading') }}" placeholder="e.g. Annual Reports" required>
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control @error('title') is-invalid @enderror" id="title" type="text" name="title" value="{{ old('title') }}" placeholder="e.g. Annual Report 2025" required>
                  ...
                  <div class="col-md-6">
                    ...
                    <small class="text-secondary d-block mt-1"><b>Allowed:</b> pdf &nbsp;|&nbsp; <b>Max:</b> 10 MB</small>
                  </div>
