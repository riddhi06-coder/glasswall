    ...
    <div class="page-body">
      <div class="container-fluid">
        <div class="page-title">
          <div class="row">
            <div class="col-6"><h4>Edit Project Management</h4></div>
            <div class="col-6">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('manage-project-management.index') }}">Home</a></li>
                <li class="breadcrumb-item active">Edit Project Management</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form id="pmForm" class="row needs-validation custom-input" novalidate action="{{ route('manage-project-management.update', $record->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  @include('backend.infra.project_management._fields', ['record' => $record])
