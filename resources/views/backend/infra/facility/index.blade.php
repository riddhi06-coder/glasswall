...
<head>
    ...
    <style>
        ...
        .fac-thumb { height: 130px; width: 200px; object-fit: cover; border: 1px solid #e6e8f0; border-radius: 8px; }
    </style>
</head>
<body>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                @if($records->isEmpty())
                                    <a href="{{ route('manage-facility.create') }}" class="btn btn-primary px-5 radius-30">
                                        + Add Facility
                                    </a>
                                @endif
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <a href="{{ route('manage-facility.edit', $record->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                        <form action="{{ route('manage-facility.destroy', $record->id) }}" method="POST" class="m-0"
