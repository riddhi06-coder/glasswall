...
<head>
    ...
    <div class="page-body">
      <div class="container-fluid"><div class="page-title"><div class="row">
        ...
        <div class="col-6"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="{{ route('manage-facility.index') }}">Home</a></li><li class="breadcrumb-item active">Add Facility</li></ol></div>
      </div></div></div>
      <div class="container-fluid"><div class="row"><div class="col-md-12"><div class="card">
        ...
        <div class="card-body">
          <form id="facForm" class="row needs-validation custom-input" novalidate action="{{ route('manage-facility.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            @include('backend.infra.facility._fields', ['record' => null])
