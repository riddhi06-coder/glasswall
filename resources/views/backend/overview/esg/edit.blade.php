...
<head>
    ...
    <div class="page-body">
      <div class="container-fluid">
        <div class="page-title">
          <div class="row">
            <div class="col-6"><h4>Edit ESG Page</h4></div>
            <div class="col-6">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('manage-esg.index') }}">Home</a></li>
                <li class="breadcrumb-item active">Edit ESG</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form id="esgForm" class="row needs-validation custom-input" novalidate action="{{ route('manage-esg.update', $esg->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')

                  @include('backend.overview.esg._fields', ['esg' => $esg])
    ...
    @include('backend.overview.esg._scripts', ['esg' => $esg])
