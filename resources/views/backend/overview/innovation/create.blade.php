    ...
    <div class="page-body">
      <div class="container-fluid">
        <div class="page-title">
          <div class="row">
            <div class="col-6"><h4>Add Innovation</h4></div>
            <div class="col-6">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('manage-innovation.index') }}">Home</a></li>
                <li class="breadcrumb-item active">Add Innovation</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form id="invForm" class="row needs-validation custom-input" novalidate action="{{ route('manage-innovation.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf

                  @include('backend.overview.innovation._fields', ['innovation' => null, 'isFirst' => $isFirst])
