    ...
    <div class="page-body">
      <div class="container-fluid">
        <div class="page-title">
          <div class="row">
            <div class="col-6"><h4>Edit Director</h4></div>
            <div class="col-6">
              <ol class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form id="bodForm" class="row needs-validation custom-input" novalidate action="{{ route('manage-board-of-directors.update', $director->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')

                  @include('backend.overview.board_of_directors._fields', ['director' => $director, 'isFirst' => $isFirst])
