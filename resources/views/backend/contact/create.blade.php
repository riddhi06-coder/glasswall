...
<head>
                    ...
                    <div class="col-12">
                      <div class="tab-content" id="wizard-tabContent">
                        <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel">
                          <form id="contactForm" class="row needs-validation custom-input" novalidate action="{{ route('manage-contact-details.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
    ...
    <script>
        ...
        (function () {
            ...
            // Seed rows: keep old input on validation error.
            @if(old('social_links'))
