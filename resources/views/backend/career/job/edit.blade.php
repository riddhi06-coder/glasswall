    ...
    <div class="page-body">
      <div class="container-fluid">
        <div class="page-title">
          <div class="row">
            <div class="col-6"><h4>Edit Job</h4></div>
            <div class="col-6">
              <ol class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="row g-4 needs-validation custom-input" novalidate action="{{ route('manage-jobs.update', $job->id) }}" method="POST">
                  @csrf
                  @method('PUT')
                  ...
                  @include('backend.career.job._fields', ['job' => $job])
