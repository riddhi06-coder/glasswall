        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form id="careerForm" class="row needs-validation custom-input" novalidate action="{{ route('manage-careers-details.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  @include('backend.career.page_details._fields', ['career' => null])
