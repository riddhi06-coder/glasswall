    ...
    <div class="page-body">
      <div class="container-fluid">
        <div class="page-title">
          <div class="row">
            <div class="col-6"><h4>Edit Project Category</h4></div>
            <div class="col-6">
              <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                      <div class="tab-content" id="wizard-tabContent">
                        <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel">
                          <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-project-category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-12">
                              ...
                              <small class="text-secondary d-block mt-1">Current slug: <code>{{ $category->slug }}</code> (updates if the name changes).</small>
                            </div>

                            <!-- Priority -->
                            <div class="col-md-6">
                              <label class="form-label" for="priority">Priority <span class="text-danger">*</span></label>
                              <input class="form-control @error('priority') is-invalid @enderror" id="priority" type="number" name="priority" min="0" value="{{ old('priority', $category->priority) }}" placeholder="e.g. 1" required>
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="mt-2">
                                <img id="thumbnail_preview" src="{{ asset('project/categories/'.$category->thumbnail) }}" style="max-height:120px; border:1px solid #ddd; padding:4px; border-radius:6px;" alt="thumbnail">
                              </div>
                            </div>
