      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">  
            <div class="logo-wrapper"> <a href="index.html"><img class="img-fluid for-light" src="{{ asset('admin/assets/images/logo/gws.webp') }}" alt="logo-light" style="background-color:#6c757d;"><img class="img-fluid for-dark" src="{{ asset('admin/assets/images/logo/gws.webp') }}" alt="logo-dark" style="background-color:#6c757d;"></a></div>
