              ...
              <div class="row align-items-center mb-5">
                <div class="col-lg-12">
                  <div class="tp-section-title-wrap tp_fade_anim tp-text-center" data-dure=".9">
                    ...
                    <h2 class="tp-section-title mb-25">Explore Our Product Range</h2>
                    <div class="mt- section-heading">
                      <p class="sub-title">
                        {{ optional($categories->first())->short_description
                            ?: 'Explore our complete range of premium architectural aluminium solutions designed for residential, commercial and industrial projects.' }}
                      </p>
                    </div>
                  ...
                  <div class="col-lg-4">
                    <article class="product-card large">
                      ...
                      <div class="card-content">
                        ...
                        <a href="{{ route('frontend.products_category', $category->slug) }}">
                          Learn More
